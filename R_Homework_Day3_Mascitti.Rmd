...
I went a bit overkill on this assignment. I try not to be the "over-achiever" type but it was a nice chance to practice data wrangling and learn a couple new functions. 
Also spent the time to play around with Github pages and figured out how to create a link for the reader to [**download the source .Rmd document**](https://evanmascitti.github.io/ecol-597-programming-for-ecologists/R_Homework_Day3_Mascitti.Rmd). Pretty cool!
...
hex_codes <- read_csv("iris-hex-codes.csv") 
...
I chose a following figure from _The Economist_ (see below).
